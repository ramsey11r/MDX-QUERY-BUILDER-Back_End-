...
{
    public class frc2Controller : ApiController
    {
        ...
        public HttpResponseMessage Post(frc a)
        {
            ...
            string query = @"select non  empty(" + a.selectdimentionrows + ".members) on rows, non empty{" + a.selectmeasurecolumns + "} on columns from [BI]";
